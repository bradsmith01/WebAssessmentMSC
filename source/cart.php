...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" hre="../css/login.css">

        <!--Title of my page-->
        <title>BAYKOST &dash; Cart</title>
    ...
    <body>
        ...
        <!--Header for Page with Log In Link-->
        <div class="row align-items-center" style="background: grey;">
            <div class="col text-center">
              <!--Will just show as 'Cart'. However, if the user is logged in it will display their name space cart to indicate theyre logged into the session-->
                <h2 class="text-decoration-underline text-light"><?php echo htmlspecialchars($_SESSION["username"]); ?>   Cart</h2>
                <p class="text-light">Free Shipping on Orders over £50</p>
                <h1 class="text-light">___________________________________________</h1>
            </div>
        </div>
        <!--End Of Header for Page with Log In Link-->

        <!--Start of Cart Listing-->
        <h2 class="text-center text-decoration-underline">Items In Your Cart</h2>

        <!--Items in cart and Checkout-->
        <div class="container border border-dark" style="height:10rem;">
            <div class="row">
                <div class="col">
                    <img src="../assets/BAYKOST_CLASSIC_SUED_CAP_1.png" style="width:10rem; height:10rem;" class="border border-dark">
                </div>
                <div class="col">
                    <h5><br></h5>
                    <h4>Product:   Baykot Classic Suede Cap White</h4>
                    <h4>£25</h4>
                    <h5><br></h5>
                </div>
                <div class="col">
        ...
        <div class="container border border-dark">
            <div class="row">
                <div class="col">
                    <img src="../assets/BAYKOST_SUPEROVERSIZE_HOODIE_GREY_1.png" style="width:10rem; height:10rem;" class="border border-dark">
                </div>
                <div class="col">
                    <h5><br></h5>
                    <h4>Product:   Baykot SuperOverSized Bundle Grey</h4>
                    <h4>£70</h4>
                    <h5><br></h5>
                </div>
                <div class="col">
        ...
        <div class="container">
            <div class="row">
              ...
              <div class="col">
                ...
                <img class="img-thumbnail rounded mx-auto d-block" src="../assets/payments.png" style="width:20rem;">
                <h3><br></h3>
                <!--CARD DETAILS INPUT-->
          
                <form action="" method="post">
                  <label>Name On Card</label>
                  <input type="text" name="text" class="form-control text-center" placeholder="Mr Joe Bloggs">
                  <label>Card Number</label>
                  <input type="text" name="text" class="form-control text-center" placeholder="**** **** **** ****">
                  <label>Card Expiry</label>
                  <input type="text" name="text" class="form-control text-center" placeholder="01/25">
                  ...
                  <div class="form-check form-switch align-items-center text-center">
                    ...
                    <label class="form-check-label" for="flexSwitchCheckDefault">Save Payment Method</label>
                    </div>
                    <h4><br></h4>
                </form>
              </div>
            ...
            <div class="row">
                <div class="col text-center">
                    <h3><br></h3>
                    <a href="../source/thankYou.php" class="text-center btn btn-dark ">Checkout</a>
                    <h3><br></h3>
                    <h3><br></h3>
                </div>
            </div>
