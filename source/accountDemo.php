...
?>
<!--Need to add a demo Layout of how the Accounts page will look for a user-->
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <!--Title of my page-->
        <title>BAYKOST &dash; Account</title>
    ...
    <body>
        ...
        <!--Start of top Account Nav-->
        <div class="row text-center">
          <div class="col">
          <h1 class="my-5 text-decoration-underline">Hi, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></h1>
          </div>
        </div>
        <div class="row text-center">
            <div class="col">
                <h4><br></h4>
                <a href="../source/error404.php" class="text-center btn btn-dark">My Account Details</a>
            </div>
            <div class="col">
                <h4><br></h4>
                <a href="../source/error404.php" class="text-center btn btn-dark">My Orders</a>
            </div>
            <div class="col">
                <h4><br></h4>
                <a href="../source/forgotPassword.php" class="text-center btn btn-dark">Reset Password</a>
            </div>
            <div class="col">
                <h4><br></h4>
                <a href="../source/logout.php" class="text-center btn btn-danger">Log Out</a>
            </div>
            <h1><br></h1>
        </div>
        <!--End of top Account Nav-->

        <!--Start of Fake Account-->
        <div class="row">
            <div class="col text-right">
                <h5 class="text-center text-decoration-underline">Name:</h5>
                <h5 class="text-center text-decoration-underline">Address:</h5>
            </div>
            <div class="col text-left">
                <h5 class="text-decoration-underline">Joe Bloggs</h5>
                <h5 class="text-decoration-underline">55 AnyWhere Avenue, Sheldon, Birmingham, B55 3YV</h5>
            </div>
        </div>
        <!--Start of Previous Order Box-->
        <div class="row">
            <div class="col">
                <h5><br></h5>
                <h5><br></h5>
                <h5 class="text-center text-decoration-underline">Your Previous Order:</h5>
            </div>
        </div>
        <div class="container border border-dark">
            <div class="row">
                <div class="col">
                    <img src="../assets/BAYKOST_CLASSIC_SUED_CAP_1.png" style="width:10rem;" class="border border-dark">
                </div>
                <div class="col">
                    <h5><br></h5>
                    <h4>Product:   Baykot Classic Suede Cap White</h4>
                    <h4>Expected Delivery:   23rd March</h4>
                    <h5><br></h5>
                </div>
            </div>
        </div>
        <h1><br></h1>
        <!--End Of Previous Order Box-->
        <!--Start Of Footer-->
