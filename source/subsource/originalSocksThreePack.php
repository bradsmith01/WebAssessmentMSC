  ...
  ?>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div id="carouselExampleControls" class="carousel slide w-75 align" data-bs-ride="carousel" style="border-color: 2px black;">
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="../../assets/BAYKOST_ORIGINAL_SOCKS_1.png" class="d-block w-100 h-100" alt="BAYKOST SuperOverSized Sweats in Beige">
                          </div>
                          <div class="carousel-item">
                            <img src="../../assets/BAYKOST_ORIGINAL_SOCKS_2.png" class="d-block w-100 h-100" alt="BAYKOST SuperOverSized Sweats in Beige">
                          </div>
                          <div class="carousel-item">
                            <img src="../../assets/BAYKOST_ORIGINAL_SOCKS_3.png" class="d-block w-100 h-100" alt="BAYKOST SuperOverSized Sweats in Beige">
                          </div>
                        </div>
                ...
                <div class="col-md-7">
                    <h3><br></h3>
                    <h3 class="text-center">Original Socks 3 Pack</h3>
                    ...
                    <div class="text-center">
                        ...
                        <div id="myDIV" style="display:none;"><p><br>The Original Baykost PureFit Socks offer supreme comfort, <br>durability and breathable thanks to its mix of reinforced stretch, <br>ribbing and venting. Whether it's an intense gym session or a<br> chill day at home, these have got you covered!

                            - 3 pairs per pack<br>
                            - Rib from mid-foot to calf<br>
                            - Birds eye stretch mesh-fabric around top foot<br>
                            - Knit to heel and toe for cushioning<br>
                            - Cuffed rib<br>
                            - Jacquard Baykost logo on both sides<br>
                            - Small: 3-8, Large (9-13)<br></p></div>
                    </div>
                    <!--End Of Description-->
