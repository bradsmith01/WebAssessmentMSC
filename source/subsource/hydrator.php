  ...
  ?>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div id="carouselExampleControls" class="carousel slide w-75 align" data-bs-ride="carousel" style="border-color: 2px black;">
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="../../assets/BAYKOST_HYDRATOR_1.png" class="d-block w-100 h-100" alt="BAYKOST Hydrator">
                          </div>
                        </div>
                ...
                <div class="col-md-7">
                    <h3><br></h3>
                    <h3 class="text-center">Hydrator</h3>
                    <p class="text-center" style="color:grey;">Product Code: 1234QWERT</p>
                    <!--End Of Title-->                
                    ...
                    <div class="text-center">
                        ...
                        <div id="myDIV" style="display:none;"><p>Introducing Baykost’s very first Accessory <br>(and one of our BEST SELLING products!) –<br> the BAYKOST HYDRATOR water bottle!

                            <br>Key features<br>
                            
                            – Keeps your liquid COLD<br>
                            
                            – Keeps your liquid HOT<br>
                            
                            – Stainless steel, thermal insulation<br>
                            
                            – Sleek, minimal design<br>
                            
                            – 500ml<br>
                            
                            – Open screw cap lid<br>
                            
                            – Includes removable filter<br><br>
