  ...
  ?>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div id="carouselExampleControls" class="carousel slide w-75 align" data-bs-ride="carousel" style="border-color: 2px black;">
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="../../assets/BAYKOST_WELFARE_HOODIE_BLACK_1.png" class="d-block w-100 h-100" alt="BAYKOST SuperOverSized Sweats in Beige">
                          </div>
                          <div class="carousel-item">
                            <img src="../../assets/BAYKOST_WELFARE_HOODIE_BLACK_2.png" class="d-block w-100 h-100" alt="BAYKOST SuperOverSized Sweats in Beige">
                          </div>
                          <div class="carousel-item">
                            <img src="../../assets/BAYKOST_WELFARE_HOODIE_BLACK_3.png" class="d-block w-100 h-100" alt="BAYKOST SuperOverSized Sweats in Beige">
                          </div>
                        </div>
                ...
                <div class="col-md-7">
                    <h3><br></h3>
                    <h3 class="text-center">Welfare Hoodie Black</h3>
                    ...
                    <div class="text-center">
                        ...
                        <div id="myDIV" style="display:none;"><p><br>One of our most loved hoodies! <br>Crafted with thick high GSM material, <br>it provides extreme comfort and keeps you warm <br>all winter and in the summer nights! <br>A must-have piece from the Baykost collection!<br>

                            Features:<br>
                            
                            Material: Super soft 100% Cotton<br>
                            
                            High GSM Material<br>
                            
                            Embroidered Baykost logo on the front<br>
                            
                            Extra thick and cosy hood<br>
                            
                            Front pouch/pocket<br>
                            
                            Custom Baykost label<br>
                            
                            Oversized fit for that extra level of comfort<br>
                            
                            Drawstring hood<br>
                            
                            Dropped shoulder fitment<br></p></div>
                    </div>
                    <!--End Of Description-->
