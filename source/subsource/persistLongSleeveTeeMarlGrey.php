  ...
  ?>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div id="carouselExampleControls" class="carousel slide w-75 align" data-bs-ride="carousel" style="border-color: 2px black;">
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="../../assets/BAYKOST_PERSIST_LONG_SLEEVE_TEE_MARLGREY_1.png" class="d-block w-100 h-100" alt="BAYKOST SuperOverSized Sweats in Beige">
                          </div>
                          <div class="carousel-item">
                            <img src="../../assets/BAYKOST_PERSIST_LONG_SLEEVE_TEE_MARLGREY_2.png" class="d-block w-100 h-100" alt="BAYKOST SuperOverSized Sweats in Beige">
                          </div>
                          <div class="carousel-item">
                            <img src="../../assets/BAYKOST_PERSIST_LONG_SLEEVE_TEE_MARLGREY_3.png" class="d-block w-100 h-100" alt="BAYKOST SuperOverSized Sweats in Beige">
                          </div>
                        </div>
                ...
                <div class="col-md-7">
                    <h3><br></h3>
                    <h3 class="text-center">Persist Long Sleeve Marl Grey</h3>
                    ...
                    <div class="text-center">
                        ...
                        <div id="myDIV" style="display:none;"><p><br>Crafted using the same, best-selling, <br>material blend as the resilience t-shirt, <br>the long-sleeve provides all-day comfort, <br>along with a unique stylish design.<br>

                            Key Features:<br>
                            
                            – Slim fit<br>
                            
                            – Baykost logo down the arm<br>
                            
                            – Tag-less brand label for added comfort<br>
                            
                            – Custom small Baykost label<br>
                            
                            – Material composition of 95% cotton and 5% spandex<br>
                            
                            – Subtle but prominent logo on chest<br>
                            
                            – Curved bottom<br>
                            <br>
                            
                            
                            Model wears size Small (5' 10", slim build)<br></p></div>
                    </div>
                    <!--End Of Description-->
