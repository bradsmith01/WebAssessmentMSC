  ...
  ?>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div id="carouselExampleControls" class="carousel slide w-75 align" data-bs-ride="carousel" style="border-color: 2px black;">
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="../../assets/BAYKOST_LIMITED_EDITION_DENIM_BLUE_1.png" class="d-block w-100 h-100" alt="BAYKOST SuperOverSized Sweats in Beige">
                          </div>
                          <div class="carousel-item">
                            <img src="../../assets/BAYKOST_LIMITED_EDITION_DENIM_BLUE_2.png" class="d-block w-100 h-100" alt="BAYKOST SuperOverSized Sweats in Beige">
                          </div>
                          <div class="carousel-item">
                            <img src="../../assets/BAYKOST_LIMITED_EDITION_DENIM_BLUE_3.png" class="d-block w-100 h-100" alt="BAYKOST SuperOverSized Sweats in Beige">
                          </div>
                        </div>
                ...
                <div class="col-md-7">
                    <h3><br></h3>
                    <h3 class="text-center">Limited Edition Denim Jacket - Blue</h3>
                    ...
                    <div class="text-center">
                        ...
                        <div id="myDIV" style="display:none;"><p><br>A sentimental piece for Baykost, <br>the denim jacket holds itself as remarkably unique...<br>

                            With a white, faux leather panel spanning the entire upper back, <br>complementing its denim base, the Baykost jacket gives off a professional look, <br>whilst retaining the comfort and mobility that the entire Baykost range maintains.<br>
                            
                            Being one of our most unique creations, <br>this jacket means a lot to us, and so... <br>we decided to add a little surprise inside the jacket... <br>revealed only to those who purchase it...<br>
                            
                            Key features<br>
                            
                            - Unique faux leather panel with Baykost print<br>
                            ...
                            - Lightweight denim which protects well against wind<br><br></p></div>
                    </div>
                    <!--End Of Description-->
