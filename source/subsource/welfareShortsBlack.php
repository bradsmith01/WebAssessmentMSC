  ...
  ?>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div id="carouselExampleControls" class="carousel slide w-75 align" data-bs-ride="carousel" style="border-color: 2px black;">
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="../../assets/BAYKOST_WELFARE_SHORTS_BLACK_1.png" class="d-block w-100 h-100" alt="BAYKOST SuperOverSized Sweats in Beige">
                          </div>
                        </div>
                      </div>
                </div>
                ...
                <div class="col-md-7">
                    <h3><br></h3>
                    <h3 class="text-center">Welfare Shorts Black</h3>
                    ...
                    <div class="text-center">
                        ...
                        <div id="myDIV" style="display:none;"><p><br>The product that started this whole brand. <br>Its a really soft fabric Suede Cap with a Embroidded<br> Logo Vertical on the side.<br></p></div>
                    </div>
                    <!--End Of Description-->
