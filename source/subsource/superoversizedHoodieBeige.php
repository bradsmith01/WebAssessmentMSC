  ...
  ?>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div id="carouselExampleControls" class="carousel slide w-75 align" data-bs-ride="carousel" style="border-color: 2px black;">
                        <div class="carousel-inner">
                          ...
                          <div class="carousel-item">
                            <img src="../../assets/BAYKOST_SUPEROVERSIZE_HOODIE_BEIGE_2.png" class="d-block w-100 h-100" alt="BAYKOST SuperOverSized Sweats in Beige">
                          </div>
                          <div class="carousel-item">
                ...
                <div class="col-md-7">
                    <h3><br></h3>
                    <h3 class="text-center">SuperOverSized Beige Hoodie</h3>
