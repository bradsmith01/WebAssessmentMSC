  ...
  ?>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div id="carouselExampleControls" class="carousel slide w-75 align" data-bs-ride="carousel" style="border-color: 2px black;">
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="../../assets/BAYKOST_SUPEROVERSIZE_SWEATS_GREY_1.png" class="d-block w-100 h-100" alt="BAYKOST SuperOverSized Sweats in Beige">
                          </div>
                          <div class="carousel-item">
                            <img src="../../assets/BAYKOST_SUPEROVERSIZE_SWEATS_GREY_2.png" class="d-block w-100 h-100" alt="BAYKOST SuperOverSized Sweats in Beige">
                          </div>
                          <div class="carousel-item">
                            <img src="../../assets/BAYKOST_SUPEROVERSIZE_SWEATS_GREY_3.png" class="d-block w-100 h-100" alt="BAYKOST SuperOverSized Sweats in Beige">
                          </div>
                        </div>
                ...
                <div class="col-md-7">
                    <h3><br></h3>
                    <h3 class="text-center">SuperOverSized Grey Sweats</h3>
                    <p class="text-center" style="color:grey;">Product Code: 345ASDFG</p>
                    <!--End Of Title-->                
                    ...
                    <div class="text-center">
                        ...
                        <div id="myDIV" style="display:none;"><p><br>Your go-to oversized, and we mean OVERSIZED, <br>sweats to get you into true relaxation. <br>Made with premium heavyweight fabrics, <bR>unique panelled design and overall oversized fit, <br>this is the one to get if you're going for at-home comfort.<br>

                            *We highly recommend sizing down 1 or 2 sizes<br> if you want a less oversized fit*
                            
                            - Oversized fit<br>
                            - Premium, heavyweight fabric<br>
                            - 3D Baykost Logo underneath pocket<br>
                            - Unique Overhang pockets<br>
                            - Elasticated waistband with drawcord<br>
                            - 51% Cotton, 49% Polyester<br>
                            - we've reduced the amount of swing tags we use, <br>so this product doesn't come with one.<br>
                            - Male model is 5'11" and wears size XS<br></p></div>
                    </div>
                    <!--End Of Description-->
