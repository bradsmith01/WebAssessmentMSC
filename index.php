...
<html lang="en">
    <head>
        ...
        <!--All Favicons are cross compatible -->
        <!--Meta Data-->
        <meta charset="utf-8">
        ...
        <!--Title of my page-->
        <title>BAYKOST &dash; Exploit Your Passion</title>
    ...
    <body>
        ...
        <section>
            ...
            <div class="row mx-auto">
                <div class="col-md-4 text-center " id="card">
                    <div class="card mx-auto" style="width: 20rem;background-color:grey;">
                        <img src="./assets/BAYKOST_SUPEROVERSIZE_HOODIE_BEIGE_1.png" class="card-img-top" alt="BAYKOST SUPEROVERSIZED HOODIE BEIGE">
                        <div class="card-body">
                          <h5 class="card-title">BAYKOST SuperOverSized Hoodie Beige</h5>
                          <p class="card-text">Minimal and comfy hoodie in an oversized fit. Unisex, Beige.</p>
                          <a href="./source/subsource/superoversizedHoodieBeige.php" class="btn btn-dark">Hoodie Details</a>
                        </div>
                      </div>
                </div>
                <!--Second Card-Bottoms-->
                <div class="col-md-4 text-center" id="card">
                    <div class="card mx-auto" style="width: 20rem;background-color:grey;">
                        <img src="assets/BAYKOST_SUPEROVERSIZE_SWEATS_BEIGE_1.png" class="card-img-top" alt="BAYKOST SUPEROVERSIZED HOODIE BEIGE">
                        <div class="card-body">
                          <h5 class="card-title">BAYKOST SuperOverSized Sweats Beige</h5>
                          <p class="card-text">Minimal and comfy hoodie in an oversized fit. Unisex, Beige.</p>
                          <a href="./source/subsource/superoversizedSweatsBeige.php" class="btn btn-dark">Sweats Details</a>
                        </div>
                      </div>
                </div>
                <!--Bundle Card Beige-->
                <div class="col-md-4" id="card">
                    <div class="card mx-auto" style="width: 20rem;background-color:grey;">
                        <div class="card-body">
                          <h5 class="card-title">ALL NEW - BAYKOST SuperOverSized Bundle Beige</h5>
                          <p class="card-text">Minimal and comfy hoodie in an oversized fit. Unisex, Beige.</p>
                          <p class="card-text">By Buying both items in the bundle you save approximatley</p>
                          <h5 class="card-title text-light text-center">26% In Savings<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br></h5>
                          <a href="./source/subsource/superoversizedBundleBeige.php" class="btn btn-dark">Bundle Details</a>
                        </div>
                      </div>
                </div>
            </div>
            ...
            <!--Start Of Text Divider-->
            <div class="row">
                <div class="col">
                    <h2 class="text-center"><br></h2>
                    <h3 class="text-center">Our All New SuperOverSized Bundles in both Grey and Beige are a cutomers favourite. <br>Great if you want to wear some comfies around the house. <br>Or if you just want to go out and not be too bothered about what to wear. <br>The SuperOverSized Bundle has got your back.</h3>
                    <h2 class="text-center"><br></h2>
                </div>
            </div>
            <!--End of Text Divider-->

            <!--Text About SuperOVerSized Bundles-->

            <!--Start Of Featured Items-->
            <div class="row">
                <div class="col">
                    <h3 class="text-center">______________</h3>
              ...
              <h4><br></h4>
                <!--Item 1 in the Row-->
                  <div class="col" id="card">
                    <div class="card mx-auto" style="width: 12rem;background-color:grey;">
                      <img src="./assets/BAYKOST_WELFARE_SHORTS_BLACK_1.png" class="card-img-top" style="height:12rem;"alt="BAYKOST WELFARE SHORTS Black">
                      <div class="card-body">
                  ...
                  <div class="col" id="card">
                    <div class="card mx-auto" style="width: 12rem;background-color:grey;">
                      <img src="./assets/BAYKOST_ORIGINAL_SOCKS_1.png" style="height:12rem;" class="card-img-top" alt="BAYKOST 3 PACK OF ORIGINAL SOCKS WHITE">
                      <div class="card-body">
                        <h5 class="card-title">Original 3 Pack of  Socks</h5>
                  ...
                  <div class="col" id="card">
                    <div class="card mx-auto" style="width: 12rem;background-color:grey;">
                      <img src="./assets/BAYKOST_CLASSIC_SUED_CAP_1.png" style="height:12rem;" class="card-img-top" alt="BAYKOST SUEDE CAP WHITE">
                      <div class="card-body">
                        <h5 class="card-title">Original Suede Cap</h5>
                  ...
                  <!--Item 4 in the Row-->
                  <div class="col" id="card">
                    <div class="card mx-auto" style="background-color:grey;width: 12rem;">
                      <img src="./assets/BAYKOST_SIMPLICITY_BEANIE_SNOWWHITE_1.png" style="height:12rem;" class="card-img-top" alt="BAYKOST SIMPLICITY BEANIE SNOW WHITE">
                      <div class="card-body">
            ...
            <!--About Our Brand Divider-->
            <div class="row">
                <div class="col">
                    <h3 class="text-center">______________</h3>
                    <h3 class="text-center"><br></h3>
                    <h3 class="text-center">About Our Brand</h3>
                    <h3 class="text-center"><br></h3>
                    <h3 class="text-center">______________</h3>
                </div>
            </div>
            <div class="row text-center">
                <div class="col">
                    <h5 class="text-center">Baykost. That's who we are. <br>We exist to support people Exploit Their Passion.<br>

                        The name Baykost derives from the Czech word Uzkost, <br>translating to a word that sits very close to the heart with the founder. Anxiety.</h5>
                    <a href="./source/brand.php" class="text-center btn btn-dark">More About Our Brand</a>
                    <h1><br></h1>
                </div>
            </div>
        </section>
