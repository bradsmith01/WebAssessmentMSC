...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" hre="../css/thankYou.css">
    ...
    <body>
        ...
        <nav class="navbar navbar-fixed-top navbar-expand-sm navbar-light bg-light">
          <div class="container">
              ...
              <form class="d-flex">
                  <input class="form-control me-2" type="search" name="search"placeholder="Search BAYKOST" aria-label="Search">
                  <button class="btn btn-outline-dark" id="searchButton" name="submit" type="submit">Search</button>
              </form>
